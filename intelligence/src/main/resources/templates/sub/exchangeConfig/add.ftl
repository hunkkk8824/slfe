...
<div style="margin-left: 2%;margin-top: 2%">
    ...
    <form class="form-horizontal m-t" id="exchangeForm" style="margin-left: 15px;margin-right: 15px;margin-top: 5px;">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="name" name="name" class="form-control" type="text" placeholder="交换机名称">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><font color="red">* </font>主机地址：</label>
            <div class="col-sm-8">
                <input id="host" name="host" class="form-control" placeholder="主机地址" type="text" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><font color="red">* </font>端口：</label>
            <div class="col-sm-8">
                <input id="port" name="port" placeholder="端口" class="form-control" type="text" >
            </div>
        </div>
        <div class="form-group">
